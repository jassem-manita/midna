...
def filter_standard_library(imports: Set[str]) -> Set[str]:
    ...
    stdlib_modules = {
        ...
        'tempfile', 'glob', 'fnmatch', 'linecache', 'pickle', 'copy',
        'pprint', 'textwrap', 'string', 'io', 'codecs', 'locale',
        'calendar', 'hashlib', 'hmac', 'secrets', 'uuid', 'urllib',
        'http', 'email', 'html', 'xml', 'csv', 'sqlite3', 'zlib',
        'gzip', 'bz2', 'lzma', 'zipfile', 'tarfile', 'threading',
        'multiprocessing', 'concurrent', 'queue', 'socket', 'ssl',
        'asyncio', 'unittest', 'doctest', 'trace', 'pdb', 'profile',
        'warnings', 'inspect', 'dis', 'importlib', 'pkgutil', 'platform',
        'ctypes', 'struct', 'array', 'weakref', 'gc', 'types'
    }
