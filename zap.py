...
def install_packages(packages: List[str], dry_run: bool = False) -> tuple:
    ...
    print(f"   * Overall success rate: {total_successful}/{total_packages} ({success_rate:.1f}%)")
...
def main():
    parser = argparse.ArgumentParser(description="ZAP - A smarter pip requirements installer")
